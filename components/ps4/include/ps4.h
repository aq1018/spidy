...
typedef void (*ps4_connection_object_callback_t)(void* object,
                                                 uint8_t isConnected);

typedef void (*ps4_event_callback_t)(ps4_t ps4, ps4_event_t event);
typedef void (*ps4_event_object_callback_t)(void* object, ps4_t ps4,
                                            ps4_event_t event);
...
bool ps4IsConnected();
void ps4Init();
void ps4InitWithMac(const char* addr);
void ps4Enable();
