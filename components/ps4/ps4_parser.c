...
ps4_event_t parseEvent(ps4_t prev, ps4_t cur) {
  ...
  ps4Event.button_down.downright =
      !prev.button.downright && cur.button.downright;
...
ps4_status_t parsePacketStatus(uint8_t* packet) {
  ...
  ps4Status.charging =
      packet[packet_index_status] & ps4_status_mask_charging ? true : false;
  ps4Status.audio =
      packet[packet_index_status] & ps4_status_mask_audio ? true : false;
  ps4Status.mic =
      packet[packet_index_status] & ps4_status_mask_mic ? true : false;
